...
using Blastic.Maui.DynamicControls.Presenters;
...
public class PresenterSource : IPresenterSource
{
	...
	public IPresenter CreatePresenter(IElement element)
	{
		...
		presenter.HorizontalOptions = element.HorizontalAlignment.ToMaui();
	...
	private Microsoft.Maui.Keyboard ToMauiKeyboard(Keyboard keyboard)
	{
