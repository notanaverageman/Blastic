...
namespace Blastic.Uno.Shared.Controls
{
	[ContentProperty(Name = "ChildContent")]
	public sealed partial class ChildWindow
	{
		...
		private static void OnIsOpenChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
		{
			...
			if ((bool) e.NewValue)
			{
				VisualStateManager.GoToState(childWindow, "Open", true);
				childWindow.Focus(FocusState.Programmatic);
			}
			else
			{
				VisualStateManager.GoToState(childWindow, "Closed", true);
			}
		}
	}
}