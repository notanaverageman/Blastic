...
namespace Blastic.ControlExtensions
{
	...
	public static class TextBoxMasking
	{
		...
		public static readonly DependencyProperty MaskProperty = DependencyProperty.RegisterAttached(
			...
			new PropertyMetadata(default(string), OnMaskChanged));
		...
		public static readonly DependencyProperty MaskExpressionProperty = DependencyProperty.RegisterAttached(
			...
			typeof(Regex),
			typeof(TextBoxMasking),
			new PropertyMetadata(default(Regex)));

		public static string GetMask(DependencyObject obj)
		{
			return obj.GetValue(MaskProperty) as string;
		}

		public static void SetMask(DependencyObject obj, string mask)
		{
			obj.SetValue(MaskProperty, mask);
		}

		private static Regex GetMaskExpression(DependencyObject obj)
		{
			return obj.GetValue(MaskExpressionProperty) as Regex;
		}

		private static void SetMaskExpression(DependencyObject obj, Regex regex)
		{
			obj.SetValue(MaskExpressionProperty, regex);
		}
