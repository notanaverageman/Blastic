...
namespace Blastic.Controls.DynamicControls.Elements
{
	...
	{
		IReactiveProperty<Symbol?> Icon { get; set; }
	...
	public abstract class Element : IElement
	{
		...
		public Element()
		{
			Icon = new ReactiveProperty<Symbol?>();
	...
	{
		public static T WithIcon<T>(this T element, Symbol? icon) where T : IElement
		{
			element.Icon.Value = icon;
			return element;
		}

		public static T WithIcon<T>(this T element, IReactiveProperty<Symbol?> icon) where T : IElement
		{
			element.Icon = icon;
			return element;
		}
